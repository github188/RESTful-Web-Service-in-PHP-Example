...
//SQL statement
$sqlQuery = "SELECT praise.post_id,praise.user_id,praise.timestamp,user.nickname FROM praise INNER JOIN user ON praise.user_id = user.user_id WHERE post_id = ".$post_id." AND AND praise.timestamp < '".$pre_create_milli."';";
